...
char wifissid[MAX_SSID_SIZE];
char wifipass[MAX_PASSWORD_SIZE];
uint8_t keynum = 0;
...
void aws_iot_task(void *param)
{
    ...
    mqttInitParams.pRootCALocation = (const char *)rootca_crt_start;
    ...
    connectParams.pClientID = serialstr;
    connectParams.clientIDLen = (uint16_t) strlen(serialstr);
...
void app_main()
{
    ...
    xTaskCreatePinnedToCore(&aws_iot_task, "aws_iot_task", 9126, NULL, 5, NULL, 1);
}